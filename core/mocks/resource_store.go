...
func (_c *ResourceStore_List_Call) RunAndReturn(run func(context.Context, resource.Filter) ([]resource.Resource, error)) *ResourceStore_List_Call {
	_c.Call.Return(run)
	return _c
}
...
type mockConstructorTestingTNewResourceStore interface {
	mock.TestingT
	Cleanup(func())
}
