...
// GetLogOptions provides a mock function with given fields: ctx, res
func (_m *ModuleService) GetLogOptions(ctx context.Context, res module.ExpandedResource) (*resource.LogOptions, error) {
...
// ModuleService_GetLogOptions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLogOptions'
type ModuleService_GetLogOptions_Call struct {
	*mock.Call
}

// GetLogOptions is a helper method to define mock.On call
//  - ctx context.Context
//  - res module.ExpandedResource
func (_e *ModuleService_Expecter) GetLogOptions(ctx interface{}, res interface{}) *ModuleService_GetLogOptions_Call {
	return &ModuleService_GetLogOptions_Call{Call: _e.mock.On("GetLogOptions", ctx, res)}
}

func (_c *ModuleService_GetLogOptions_Call) Run(run func(ctx context.Context, res module.ExpandedResource)) *ModuleService_GetLogOptions_Call {
...
func (_c *ModuleService_GetLogOptions_Call) Return(_a0 *resource.LogOptions, _a1 error) *ModuleService_GetLogOptions_Call {
