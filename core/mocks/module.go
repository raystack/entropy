...
func (_m *Module) Plan(ctx context.Context, spec module.Spec, act module.ActionRequest) (*module.Plan, error) {
...
func (_c *Module_Plan_Call) Return(_a0 *module.Plan, _a1 error) *Module_Plan_Call {
