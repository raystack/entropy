...
// UpdateModule provides a mock function with given fields: ctx, urn, spec
func (_m *ModuleService) UpdateModule(ctx context.Context, urn string, spec module.Spec) (*module.Module, error) {
	ret := _m.Called(ctx, urn, spec)

	var r0 *module.Module
	if rf, ok := ret.Get(0).(func(context.Context, string, module.Spec) *module.Module); ok {
		r0 = rf(ctx, urn, spec)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*module.Module)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, module.Spec) error); ok {
		r1 = rf(ctx, urn, spec)
	} else {
		r1 = ret.Error(1)
	}
...
//  - urn string
//  - spec module.Spec
func (_e *ModuleService_Expecter) UpdateModule(ctx interface{}, urn interface{}, spec interface{}) *ModuleService_UpdateModule_Call {
	return &ModuleService_UpdateModule_Call{Call: _e.mock.On("UpdateModule", ctx, urn, spec)}
}

func (_c *ModuleService_UpdateModule_Call) Run(run func(ctx context.Context, urn string, spec module.Spec)) *ModuleService_UpdateModule_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(module.Spec))
	})
	return _c
}
