...
func (_m *ResourceService) ListResources(ctx context.Context, filter resource.Filter, withSpecConfigs bool) ([]resource.Resource, error) {
...
func (_c *ResourceService_ListResources_Call) RunAndReturn(run func(context.Context, resource.Filter, bool) ([]resource.Resource, error)) *ResourceService_ListResources_Call {
	_c.Call.Return(run)
	return _c
}
