...
func (_c *ModuleService_Log_Call) Run(run func(ctx context.Context, r *domain.Resource, filter map[string]string)) *ModuleService_Log_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *ModuleService) Validate(ctx context.Context, r *domain.Resource) error {
	ret := _m.Called(ctx, r)
...
func (_c *ModuleService_Validate_Call) Run(run func(ctx context.Context, r *domain.Resource)) *ModuleService_Validate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.Resource))
	})
	return _c
