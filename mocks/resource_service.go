...
func (_m *ResourceService) DeleteResource(ctx context.Context, res *domain.Resource) (*domain.Resource, error) {
	ret := _m.Called(ctx, res)
...
//  - ctx context.Context
//  - res *domain.Resource
func (_e *ResourceService_Expecter) DeleteResource(ctx interface{}, res interface{}) *ResourceService_DeleteResource_Call {
	return &ResourceService_DeleteResource_Call{Call: _e.mock.On("DeleteResource", ctx, res)}
}

func (_c *ResourceService_DeleteResource_Call) Run(run func(ctx context.Context, res *domain.Resource)) *ResourceService_DeleteResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.Resource))
	})
	return _c
...
func (_c *ResourceService_DeleteResource_Call) Return(_a0 *domain.Resource, _a1 error) *ResourceService_DeleteResource_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
